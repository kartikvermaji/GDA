...
const Hero = () => {
  ...
  return (
    ...
    <div className='h-[110vh] bg-black' id='home'>
      <Navbar/>
    <motion.div className='bg-[#000000] h-[100vh]  ' 
  // style={{ scale }}
    >
      <motion.div
       ...
       className='lg:text-8xl text-4xl md:text-7xl font-semibold text-center  text-slate-800 pt-20 absolute opacity-20'>
        ...
        <motion.img
            ...
            whileInView={{ opacity: 1, y: 0 }}
             src={drone} alt="" className=' absolute lg:h-[75vh] md:h-[60vh] h-[50vh] object-cover ml-[-19vw] md:ml-[-23vw]  lg:ml-[-20vw] mt-28 drop-shadow-xl shadow-slate-200'  />
        ...
        <div className='text-slate-50'>
             ...
             <motion.div
              ...
              <p className='text-sm lg:text-md pt-1 font-light hidden md:block'>Excellent propellers power an excellent drive</p>
             </motion.div>
             ...
             className='flex  w-12 md:w-[25vw] lg:w-[15vw] bg-slate-700 rounded-full absolute mt-[30vh] md:mt-[28vh]  ml-[-80vw] lg:mt-[26vh] md:ml-[-75vw] lg:ml-[-53vw] shadow-xl hover:shadow-slate-700 duration-300 shadow-slate-900 '>
              ...
              <p className='text-sm lg:text-mdpt-1 pl-1 font-light hidden md:block'>Lightweight motors for extended flight times</p>
             </motion.div>
             ...
             whileInView={{ opacity: 1 }}
              ...
              <p className='pt-1 text-sm lg:text-md font-light hidden md:block'>Uncompromising Clarity. Unforgettable Shots</p>
             </motion.div>
             ...
             whileInView={{ opacity: 1 }}
              ...
              <p className='text-sm lg:text-md pt-1 pl-1 font-light hidden md:block'>Sleek and stable drone stands</p>
             </motion.div>
        </div>
